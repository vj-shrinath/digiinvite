...
export function InvitationCard({ data }: InvitationCardProps) {
  ...
  return (
    <div id="invitation-content" ref={containerRef} className={cn("text-center font-body text-primary-foreground space-y-8", data.theme)}>
      {/* Page 1: Main Welcome */}
      <section className="first-page fade-in-element relative">
        <div className="absolute left-0 bottom-[20px] z-20 md:ml-[203px]">
          {coupleImageToShow && (
            <Image
