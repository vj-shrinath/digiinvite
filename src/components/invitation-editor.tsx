  ...
  const handleDownload = async (format: 'png' | 'pdf') => {
    ...
    if (!element) {
      toast({
        ...
        description: 'Could not find invitation content to download.',
      });
      return;
    }
    ...
    toast({
      title: 'Downloading...',
      description: `Your invitation is being prepared as a ${format.toUpperCase()} file.`,
    });

    // Temporarily make scrollbar invisible to not capture it in the image
    ...
    element.style.overflow = originalStyle; // Restore scrollbar
  ...
  return (
    <>
      <AdminBar
        ...
        onDownloadImage={() => handleDownload('png')}
