...
import { Loader2, Edit, Eye, Save, Copy, LogOut, LayoutDashboard, ArrowLeft, Download } from "lucide-react";
    ...
    <div className="sticky top-0 z-40 w-full bg-background/80 backdrop-blur-md shadow-sm">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {user && !isEditing && onDownloadImage && onDownloadPdf && (
            <>
              <Button onClick={onDownloadImage} variant="outline" size="sm">
